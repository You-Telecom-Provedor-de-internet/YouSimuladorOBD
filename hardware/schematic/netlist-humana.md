...
- `GND -> J1-4, J1-5, U1-IN-, U1-OUT-, MCU1-GND, U2-2(GND), U2-8(RS), U3-5(GND), CK1-2, CK2-2, DISP1-GND, ENC1-GND, SW2-SW7-retorno, SW1-comum, D3-catodo` `[DE]`
- `+5V_SYS -> U1-OUT+, MCU1-VIN` `[DE]`
- `+5V_SYS -> U4-IN` `[DE]`
- `+3V3_AUX -> U4-OUT, U2-3(VCC), U3-3(VCC), DISP1-VCC, ENC1-VCC, RDIP1-1, RDIP2-1, RDIP3-1` `[DE]`
...
- `ENC_A -> MCU1-GPIO14, ENC1-CLK` `[CC/DE]`
- `ENC_B -> MCU1-GPIO13, ENC1-DT` `[CC/DE]`
- `ENC_SW -> MCU1-GPIO19, ENC1-SW` `[CC/DE]`
...
- `BTN_PROTOCOL -> MCU1-GPIO18, SW7` `[CC/DE]`
